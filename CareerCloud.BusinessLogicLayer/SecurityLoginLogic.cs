...
public class SecurityLoginLogic : BaseLogic<SecurityLoginPoco>
{
    ...
    protected override void Verify(SecurityLoginPoco[] pocos)
    {
        ...
        foreach (var poco in pocos)
        {
            ...
            {
                exceptions.Add(new ValidationException(700, "Length must be 10 or greater"));
             }
            ...
            {
                exceptions.Add(new ValidationException(701, "Must contain one of the followingcharacters (\"$\", \"*\", \"#\", \"_\", \"@\")"));
            }

            if (string.IsNullOrEmpty(poco.PhoneNumber))
            {
                exceptions.Add(new ValidationException(702, "Cannot be blank"));
             }
            else
            {
                ...
                {
                    exceptions.Add(new ValidationException(703, "Must conform to a phone numberpattern (e.g. 416-555-1234)"));
                 }
                else
                {
            ...
            if (string.IsNullOrEmpty(poco.EmailAddress))
            {
                ...
                exceptions.Add(new ValidationException(704, ""));
            }
            ...
            {
                exceptions.Add(new ValidationException(704, "Cannot be empty and must matcha valid email address pattern (e.g.someone@shomewhere.com)"));
            }

            if (string.IsNullOrEmpty(poco.FullName))
            {
                exceptions.Add(new ValidationException(705, "Cannot be empty"));
            }
