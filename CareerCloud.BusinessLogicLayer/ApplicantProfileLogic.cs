...
namespace CareerCloud.BusinessLogicLayer
{
    public class ApplicantProfileLogic : BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            {
                if (poco.CurrentSalary < 0) exceptions.Add(new ValidationException(111, "CurrentSalary cannot be negative"));

                if (poco.CurrentRate < 0) exceptions.Add(new ValidationException(112, "CurrentRate cannot be negative"));
            }
